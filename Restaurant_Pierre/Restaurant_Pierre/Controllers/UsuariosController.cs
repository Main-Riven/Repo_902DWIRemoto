...
namespace Restaurant_Pierre.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(PierreRestaurantContext context)
        {
            _context = context;
        }
        ...
        {
            var pierreRestaurantContext = _context.Usuarios.Include(u => u.IdEmpleadoNavigation).Include(u => u.IdRolNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,Usuario1,Password,IdRol,IdEmpleado")] Usuario usuario)
        {
            ...
            ViewData["IdEmpleado"] = new SelectList(_context.Empleados, "IdEmpleado", "Nombre", usuario.IdEmpleado);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,Usuario1,Password,IdRol,IdEmpleado")] Usuario usuario)
        {
